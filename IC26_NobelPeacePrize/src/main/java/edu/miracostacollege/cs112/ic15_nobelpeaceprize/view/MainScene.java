...
public class MainScene extends Scene {
    ...
    public MainScene() {
        ...
        // DONE: Uncomment after adding image to resources folder
    ...
    private void selectLaureate(NobelLaureate newVal) {
        //Update selected laureate remove button
    ...
    private void removeLaureate() {
        //Don't remove if selected laureate is null
        if(selectedLaureate == null)
            return;

        //Remove laureate and select previous one
    ...
    private void addLaureate() {
        ...
        //Get data fields for new laureate
        name = nameTF.getText();
        ...
        } catch(NumberFormatException e) {yearErrLabel.setVisible(true);}
        ...
        try {
            ...
            yearErrLabel.setVisible(prize < 0);
        } catch(NumberFormatException e) {yearErrLabel.setVisible(true);}
