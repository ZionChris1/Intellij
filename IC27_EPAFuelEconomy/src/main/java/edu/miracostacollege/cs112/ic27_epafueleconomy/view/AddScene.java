...
public class AddScene extends Scene {
    ...
    private void save() {
        ...
        if(makeErrorLabel.isVisible() || modelErrorLabel.isVisible() | cityMPGErrorLabel.isVisible()
        || highwayMPGErrorLabel.isVisible() || annualFuelCostErrorLabel.isVisible()
        || fuelEconomyRatingErrorLabel.isVisible())
            return;
